...
myMeadian <- median(myNorm.01.100)
...
myVar <- var(myNorm.01.100) # variance
mySD <- sd(myNorm.01.100) # standard deviation
myRange <- range(myNorm.01.100) # range
...
prod(bioenv1$c + 1)^(1/length(bioenv1$c)) -1
